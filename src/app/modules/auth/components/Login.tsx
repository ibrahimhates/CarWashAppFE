...
const initialValues = {
  email: 'ibrahim@path.com',
  password: 'ibrahim123',
  // mustafa giriş bilgileri
  // email: 'yildizmustafa@hotmail.com',
  // password: 'yildizmustafa@hotmail.com',
}
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values, { setStatus, setSubmitting }) => {
      ...
      try {
        ...
        saveAuthTokenToCookie(auth)
        const { data: user } = await getUserInfosByToken(auth)
        console.log(user);
