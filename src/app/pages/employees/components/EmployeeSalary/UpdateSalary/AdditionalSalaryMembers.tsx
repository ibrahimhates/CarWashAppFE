...
import { IAdditionalSalaryUpdate } from "./UpdateSalaryModal";

type Props = {
    addSalary: IAdditionalSalaryUpdate;
    removeThis: (id: string) => void;
    salaryTypeName: string;
    updateAmount: (id: string, field: Partial<IAdditionalSalaryUpdate>) => void
}
    ...
    return (
        <>
            ...
            <div className='col-md-6'>
                <div className='mb-5'>
                    <label className='form-label'>{`Aciklama (Opsionel)`}</label>
                    <input
                        type='text'
                        disabled
                        className='form-control'
