...
import HeaderSkeletonLoader from './components/HeaderSkeletonLoader'
...
const ProfileDetailHeader: React.FC<Props> = ({
  headerDetail,
  setHeaderDetail,
  loading,
  setLoading,
              ...
              <ul className='nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bolder flex-nowrap'>
                <li className='nav-item'>
                  <Link
                    className={
                      ...
                      (location.pathname === `/profile/${id}/detail` && 'active')
                    }
                    to={`/profile/${id}/detail`}
                  >
                    Profil
                  </Link>
                </li>
                ...
                <li className='nav-item'>
                  <Link
                    className={
                      `nav-link text-active-primary me-6 ` +
                      (location.pathname === `/profile/${id}/infos` && 'active')
                    }
                    to={`/profile/${id}/infos`}
                  >
                    Genel Bilgiler
                ...
                <li className='nav-item'>
                  <Link
                    className={
                      `nav-link text-active-primary me-6 ` +
                      (location.pathname === `/profile/${id}/other/infos` && 'active')
                    }
                    to={`/profile/${id}/other/infos`}
                  >
                    Diğer Bilgiler
                  </Link>
                </li>
                ...
                <li className='nav-item'>
                  <Link
                    className={
                      `nav-link text-active-primary me-6 ` +
                      (location.pathname === `/profile/${id}/permission/infos` && 'active')
                    }
                    to={`/profile/${id}/permission/infos`}
                  >
                    İzin Bilgileri
                  </Link>
                </li>
                ...
                <li className='nav-item'>
                  <Link
                    className={
                      `nav-link text-active-primary me-6 ` +
                      (location.pathname === `/profile/${id}/payment/infos` && 'active')
                    }
                    to={`/profile/${id}/payment/infos`}
                  >
                    Avans Bilgileri
                  </Link>
                </li>
                ...
                <li className='nav-item'>
                  <Link
                    className={
                      `nav-link text-active-primary me-6 ` +
                      (location.pathname === `/profile/${id}/payments` && 'active')
                    }
                    to={`/profile/${id}/payments`}
                  >
                    Ödemeler
                  </Link>
                </li>
                ...
                <li className='nav-item'>
                  <Link
                    className={
                      `nav-link text-active-primary me-6 ` +
                      (location.pathname === `/profile/${id}/inventory` && 'active')
                    }
                    to={`/profile/${id}/inventory`}
                  >
                    Zimmet
                  </Link>
                </li>
                ...
                <li className='nav-item'>
                  <Link
                    className={
                      `nav-link text-active-primary me-6 ` +
                      (location.pathname === `/profile/${id}/salary` && 'active')
                    }
                    to={`/profile/${id}/salary`}
                  >
                    Maaş
                  </Link>
                </li>
                ...
                <li className='nav-item'>
                  <Link
                    className={
                      `nav-link text-active-primary me-6 ` +
                      (location.pathname === `/profile/${id}/position` && 'active')
                    }
                    to={`/profile/${id}/position`}
                  >
                    Pozisyon
                  </Link>
                </li>
