...
import PermissionRoute from '../PermissionToBeApproved/PermissionRoute'
import { useEffect } from 'react'

type Props = {
  leaveRequests: ILeaveRequest[]
  setLeaveRequests: (all: ILeaveRequest[]) => void
}

const TabBarForPermissionToBeApprover = ({leaveRequests, setLeaveRequests}: Props) => {


  const getAllLeaveRequest = () => {
    HttpService.get('LeaveRequest/allHaveBeen', Cookies.get('authToken'))
      .then((response) => {
...
export default TabBarForPermissionToBeApprover
